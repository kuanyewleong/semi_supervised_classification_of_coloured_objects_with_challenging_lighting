...
class DBSS(DatasetFolder):
    ...
    def one_iter_true(self, X, writer, epoch, k = 50, max_iter = 20, l2 = False , index="ip", n_labels=None):
        if l2:
            normalize_L2(X)  
        ...
        writer.add_scalar('Pseudo Label Accuracy', 100*self.acc, epoch) 
        ...
        writer.add_scalar('Pseudo Label Accuracy (DA)', 100*self.acc, epoch)
