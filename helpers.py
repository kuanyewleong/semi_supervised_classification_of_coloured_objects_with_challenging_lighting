...
def create_data_loaders_simple(weak_transformation,strong_transformation,
    ...
    train_loader = torch.utils.data.DataLoader(dataset,batch_sampler=batch_sampler,num_workers=args.workers,pin_memory=False)
...
def validate(eval_loader, model, args, global_step, epoch, num_classes =15):
